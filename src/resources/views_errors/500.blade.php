...
<head>
    ...
    <title>Error 500 - {{ config('bytenet.base.project_name') }}</title>
  ...
  <body>
    <div class="container">
      <div class="content">
        ...
        <div class="quote">{{ trans('bytenet-base::base.internal_error') }}.</div>
        <div class="explanation">
            ...
            $default_error_message = trans('bytenet-base::base.internal_error_message') . ".";
            ?>
            <p class="bold">
                <small>
