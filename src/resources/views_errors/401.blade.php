...
<head>
    ...
    <title>Error 401 - {{ config('bytenet.base.project_name') }}</title>
  ...
  <body>
    <div class="container">
      <div class="content">
        ...
        <div class="quote">{{ trans('bytenet-base::base.unauthorized_action') }}.</div>
        <div class="explanation">
            <br>
            <?php
            //$default_error_message = "Please return to <a href='".url('')."'>our homepage</a>.";
            $default_error_message = trans('bytenet-base::base.return_to_homepage_please', ['attribute' => '/']) . ".";
            ?>
            <p class="bold">
                <small>
