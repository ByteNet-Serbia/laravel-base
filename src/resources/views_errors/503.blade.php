...
<head>
    ...
    <title>Error 503 - {{ config('bytenet.base.project_name') }}</title>
  ...
  <body>
    <div class="container">
      <div class="content">
        ...
        <div class="quote">{{ trans('bytenet-base::base.gateway_timeout') }}It's not you, it's me.</div>
        <div class="explanation">
            <br>
            <?php
            //$default_error_message = "The server is overloaded or down for maintenance. Please try again later.";
            $default_error_message = trans('bytenet-base::base.gateway_timeout_message') . ".";
            ?>
            <p class="bold">
                <small>
